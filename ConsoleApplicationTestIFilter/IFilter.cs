...
namespace ConsoleApplicationTestIFilter
{
  ...
  {
    [PreserveSig]
    int Init([MarshalAs(UnmanagedType.U4)] IfilterInit grfFlags, uint cAttributes, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] FULLPROPSPEC[] aAttributes, ref uint pdwFlags);
    ...
    public static string Extract(string path)
    {
      ...
      try
      {
        ...
        IfilterInit iflags =
            ...
            IfilterInit.CANON_SPACES |
            IfilterInit.APPLY_CRAWL_ATTRIBUTES |
            IfilterInit.APPLY_INDEX_ATTRIBUTES |
            IfilterInit.APPLY_OTHER_ATTRIBUTES |
            IfilterInit.HardLineBreaks |
            IfilterInit.SEARCH_LINKS |
            IfilterInit.FILTER_OWNED_VALUE_OK;
